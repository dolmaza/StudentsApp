        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.IsSuccess) {
                    ...
                    toastrNotification.init('თქვენ შეგიძლიათ შექმნათ კიდევ ერთი სტუდენტი ან დაბრუნდეთ <a href="' + studentsUrl + '"><b>სტუდენტების გვერდზე</b></a>', { notificationType: toastrNotification.types.info, timeOut: '12000' }).showMessage();
